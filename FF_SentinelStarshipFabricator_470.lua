...
-- subgroup skirt A
PRODUCTS_SKIRT["A6"] = "YELLOW2"
PRODUCTS_SKIRT["A1S6"] = "RED2"
PRODUCTS_SKIRT["A1S3"] = "GREEN2"
PRODUCTS_SKIRT["A1S"] = "BLUE2"
PRODUCTS_SKIRT["A8"] = "EX_YELLOW"
PRODUCTS_SKIRT["A1S10"] = "EX_RED"
PRODUCTS_SKIRT["A1S11"] = "EX_GREEN"
PRODUCTS_SKIRT["A1S12"] = "EX_BLUE"

-- subgroup skirt B
PRODUCTS_SKIRT["BN"] = "OXYGEN"
PRODUCTS_SKIRT["A7"] = "CATALYST1"
PRODUCTS_SKIRT["A1S7"] = "CAVE1"
PRODUCTS_SKIRT["A1S8"] = "WATER1"
PRODUCTS_SKIRT["A1S9"] = "LAUNCHSUB"
PRODUCTS_SKIRT["A9"] = "CATALYST2"
PRODUCTS_SKIRT["A1S13"] = "CAVE2"
PRODUCTS_SKIRT["A1S14"] = "WATER2"
PRODUCTS_SKIRT["A1S15"] = "LAUNCHSUB2"
...
-- subgroup upper hull
PRODUCTS_ADDON["ASA4"] = "RED2"
PRODUCTS_ADDON["ASAE"] = "EX_RED"
...
function Modules_BuildChangeTable(exml)
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_EditSlotItemData("SCIEN_WINGEMP",PRODUCTS_SKIRT["A6"],"SENT_SB_A6"),
        Modules_EditSlotItemData("SCIEN_WINGT_A",PRODUCTS_SKIRT["A1S6"],"SENT_SB_A1S6"),
        Modules_EditSlotItemData("SCIEN_WINGT_C",PRODUCTS_SKIRT["A1S3"],"SENT_SB_A1S3"),
        Modules_EditSlotItemData("SCIEN_WINGT_F",PRODUCTS_SKIRT["A1S"],"SENT_SB_A1S"),
        Modules_EditSlotItemData("SCIEN_WINGT_G",PRODUCTS_SKIRT["A8"],"SENT_SB_A8"),
        Modules_EditSlotItemData("SCIEN_WINGT_I",PRODUCTS_SKIRT["A1S10"],"SENT_SB_A1S10"),
        Modules_EditSlotItemData("SCIEN_WINGA",PRODUCTS_SKIRT["A1S11"],"SENT_SB_A1S11"),
        Modules_EditSlotItemData("SCIEN_WINGBA",PRODUCTS_SKIRT["A1S12"],"SENT_SB_A1S12"),

        -- add skirt B variants
        Modules_EditSlotItemData("SCIEN_WINGBB",PRODUCTS_SKIRT["BN"],"SENT_SB_BN"),
        Modules_EditSlotItemData("SCIEN_WINGBC",PRODUCTS_SKIRT["A7"],"SENT_SB_A7"),
        Modules_EditSlotItemData("SCIEN_WINGBD",PRODUCTS_SKIRT["A1S7"],"SENT_SB_A1S7"),
        Modules_EditSlotItemData("SCIEN_WINGC",PRODUCTS_SKIRT["A1S8"],"SENT_SB_A1S8"),
        Modules_EditSlotItemData("SCIEN_WINGDA",PRODUCTS_SKIRT["A1S9"],"SENT_SB_A1S9"),
        Modules_EditSlotItemData("SCIEN_WINGDB",PRODUCTS_SKIRT["A9"],"SENT_SB_A9"),
        Modules_EditSlotItemData("SCIEN_WINGDC",PRODUCTS_SKIRT["A1S13"],"SENT_SB_A1S13"),
        Modules_EditSlotItemData("SCIEN_WINGDD",PRODUCTS_SKIRT["A1S14"],"SENT_SB_A1S14"),
        Modules_EditSlotItemData("SCIEN_WINGE",PRODUCTS_SKIRT["A1S15"],"SENT_SB_A1S15"),
    }
    ...
    local INSTRUCTIONS = 
    {
        ...
        Modules_EditSlotItemData("FIGHT_COCKAA",PRODUCTS_ADDON["NONE"],"SENT_ADDON_NONE"),

        Modules_EditSlotItemData("FIGHT_COCKAB",PRODUCTS_ADDON["ASA4"],"SENT_ADDON_ASA4"),
        Modules_EditSlotItemData("FIGHT_COCKAC",PRODUCTS_ADDON["ASAE"],"SENT_ADDON_ASAE"),

        Modules_EditSlotItemData("FIGHT_COCKAD",PRODUCTS_ADDON["SEA2"],"SENT_ADDON_SEA2"),
        Modules_EditSlotItemData("FIGHT_COCKAE",PRODUCTS_ADDON["AEWA"],"SENT_ADDON_AEWA"),
        
        Modules_EditSlotItemData("FIGHT_COCKB",PRODUCTS_ADDON["ASA7"],"SENT_ADDON_ASA7"),
        Modules_EditSlotItemData("FIGHT_COCKD",PRODUCTS_ADDON["ASA8"],"SENT_ADDON_ASA8"),

        Modules_EditSlotItemData("FIGHT_COCKE",PRODUCTS_ADDON["ENGA"],"SENT_ADDON_ENGA"),
        Modules_EditSlotItemData("FIGHT_COCKF",PRODUCTS_ADDON["BASA"],"SENT_ADDON_BASA"),
    }
...
function Descriptors_BuildChangeTable(exml)
    ...
    local INSTRUCTIONS =
    {
        ...
        Descr_Fill("GroupID","ASTRO_HEAD_0","SENT_SB_A6"),Descr_Reset("SENT_SB_A6"),Descr_Add("SENT_SB_A6",{"_Skirt_A","_askirting_A6"}),
        Descr_Fill("GroupID","ASTRO_HEAD_1","SENT_SB_A1S6"),Descr_Reset("SENT_SB_A1S6"),Descr_Add("SENT_SB_A1S6",{"_Skirt_A","_askirting_A1s6"}),
        Descr_Fill("GroupID","ASTRO_HEAD_2","SENT_SB_A1S3"),Descr_Reset("SENT_SB_A1S3"),Descr_Add("SENT_SB_A1S3",{"_Skirt_A","_askirting_A1s3"}),
        Descr_Fill("GroupID","ASTRO_HEAD_3","SENT_SB_A1S"),Descr_Reset("SENT_SB_A1S"),Descr_Add("SENT_SB_A1S",{"_Skirt_A","_askirting_A1s"}),
        Descr_Fill("GroupID","ASTRO_HEAD_4","SENT_SB_A8"),Descr_Reset("SENT_SB_A8"),Descr_Add("SENT_SB_A8",{"_Skirt_A","_askirting_A8"}),
        Descr_Fill("GroupID","ASTRO_HEAD_5","SENT_SB_A1S10"),Descr_Reset("SENT_SB_A1S10"),Descr_Add("SENT_SB_A1S10",{"_Skirt_A","_askirting_A1s10"}),
        Descr_Fill("GroupID","ASTRO_HEAD_6","SENT_SB_A1S11"),Descr_Reset("SENT_SB_A1S11"),Descr_Add("SENT_SB_A1S11",{"_Skirt_A","_askirting_A1s11"}),
        Descr_Fill("GroupID","ASTRO_HEAD_7","SENT_SB_A1S12"),Descr_Reset("SENT_SB_A1S12"),Descr_Add("SENT_SB_A1S12",{"_Skirt_A","_askirting_A1s12"}),

        Descr_Fill("GroupID","ASTRO_HEAD_8","SENT_SB_BN"),Descr_Reset("SENT_SB_BN"),Descr_Add("SENT_SB_BN",{"_Skirt_B","_SkirtWings_NULL"}),
        Descr_Fill("GroupID","ASTRO_HEAD_9","SENT_SB_A7"),Descr_Reset("SENT_SB_A7"),Descr_Add("SENT_SB_A7",{"_Skirt_B","_SkirtWings_A","_askirting_A7"}),
        Descr_Fill("GroupID","ASTRO_HEAD_10","SENT_SB_A1S7"),Descr_Reset("SENT_SB_A1S7"),Descr_Add("SENT_SB_A1S7",{"_Skirt_B","_SkirtWings_A","_askirting_A1s7"}),
        Descr_Fill("GroupID","TRAVLR_HEAD_1","SENT_SB_A1S8"),Descr_Reset("SENT_SB_A1S8"),Descr_Add("SENT_SB_A1S8",{"_Skirt_B","_SkirtWings_A","_askirting_A1s8"}),
        Descr_Fill("GroupID","REG_HEAD_S1","SENT_SB_A1S9"),Descr_Reset("SENT_SB_A1S9"),Descr_Add("SENT_SB_A1S9",{"_Skirt_B","_SkirtWings_A","_askirting_A1s9"}),
        Descr_Fill("GroupID","REG_HEAD_S2","SENT_SB_A9"),Descr_Reset("SENT_SB_A9"),Descr_Add("SENT_SB_A9",{"_Skirt_B","_SkirtWings_A","_askirting_A9"}),
        Descr_Fill("GroupID","REG_HEAD_XO","SENT_SB_A1S13"),Descr_Reset("SENT_SB_A1S13"),Descr_Add("SENT_SB_A1S13",{"_Skirt_B","_SkirtWings_A","_askirting_A1s13"}),
        Descr_Fill("GroupID","REG_HEAD_DIVING","SENT_SB_A1S14"),Descr_Reset("SENT_SB_A1S14"),Descr_Add("SENT_SB_A1S14",{"_Skirt_B","_SkirtWings_A","_askirting_A1s14"}),
        Descr_Fill("GroupID","REG_HEAD_BIOME1","SENT_SB_A1S15"),Descr_Reset("SENT_SB_A1S15"),Descr_Add("SENT_SB_A1S15",{"_Skirt_B","_SkirtWings_A","_askirting_A1s15"}),
    ...
    local INSTRUCTIONS =
    {
        ...
        Descr_Fill("GroupID","FIGHT_COCKAA","SENT_ADDON_NONE"),Descr_Reset("SENT_ADDON_NONE"),Descr_Add("SENT_ADDON_NONE",{""}),

        Descr_Fill("GroupID","FIGHT_COCKAB","SENT_ADDON_ASA4"),Descr_Reset("SENT_ADDON_ASA4"),Descr_Add("SENT_ADDON_ASA4",{"_asides_A4"}),
        Descr_Fill("GroupID","FIGHT_COCKAC","SENT_ADDON_ASAE"),Descr_Reset("SENT_ADDON_ASAE"),Descr_Add("SENT_ADDON_ASAE",{"_asides_Ae"}),

        Descr_Fill("GroupID","FIGHT_COCKAD","SENT_ADDON_SEA2"),Descr_Reset("SENT_ADDON_SEA2"),Descr_Add("SENT_ADDON_SEA2",{"_sideEngines_A2"}),
        Descr_Fill("GroupID","FIGHT_COCKAE","SENT_ADDON_AEWA"),Descr_Reset("SENT_ADDON_AEWA"),Descr_Add("SENT_ADDON_AEWA",{"_aEndWings_Ant"}),

        Descr_Fill("GroupID","FIGHT_COCKB","SENT_ADDON_ASA7"),Descr_Reset("SENT_ADDON_ASA7"),Descr_Add("SENT_ADDON_ASA7",{"_aAltSkirt_A","_Var_A7"}),
        Descr_Fill("GroupID","FIGHT_COCKD","SENT_ADDON_ASA8"),Descr_Reset("SENT_ADDON_ASA8"),Descr_Add("SENT_ADDON_ASA8",{"_aAltSkirt_A","_Var_A8"}),

        Descr_Fill("GroupID","FIGHT_COCKE","SENT_ADDON_ENGA"),Descr_Reset("SENT_ADDON_ENGA"),Descr_Add("SENT_ADDON_ENGA",{"_Engine_A"}),
        Descr_Fill("GroupID","FIGHT_COCKF","SENT_ADDON_BASA"),Descr_Reset("SENT_ADDON_BASA"),Descr_Add("SENT_ADDON_BASA",{"_SkirtWings_A","_AltSkirting_A"}),
